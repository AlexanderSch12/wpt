...
promise_test( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(test) {
    var child_token, child, iframe, meta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          child_token = token();
          child = new RemoteContext(child_token);
          ...
          // child.
          _context.next = 7;
          return child.execute_script(function () {
            window.sameDocumentNavigation = new Promise(function (resolve) {
        ...
        case 7:
          ...
          document.addEventListener("securitypolicyviolation", test.unreached_func("same-document navigations aren't subject to CSP"));
