...
function TestCase(scenarios, sanityChecker) {
  function runTest(scenario) {
    ...
    var urls = getRequestURLs(scenario.subresource, scenario.origin, scenario.redirection);
    ...
    var violationEventResolve;
    // Resolved with an array of securitypolicyviolation events.
    var violationEventPromise = new Promise(function (resolve) {
    ...
    promise_test( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(t) {
        var violationEvents, listener, mainPromise, timeout, assertResult;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 12:
              _context.next = 14;
              return mainPromise.then(t.unreached_func('main promise resolved unexpectedly')).catch(function (_) {});
            case 14:
              _context.prev = 14;
              ...
              timeout = 0;
              if (scenario.subresource.startsWith('worklet-') && navigator.userAgent.includes("Firefox/")) {
            ...
            case 24:
              assertResult = _context.sent;
              // Now check if the value has been torn down. If it's still there,
              // we have blocked the request by content security policy.
              assert_equals(assertResult.status, scenario.expectation, "The resource request should be '" + scenario.expectation + "'.");
            case 26:
            case "end":
              return _context.stop();
          }
        }, _callee, null, [[5,, 14, 22]]);
      }));
      return function (_x) {
      ...
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return violationEventPromise;
            case 2:
              violationEvents = _context2.sent;
              if (scenario.expectation === 'allowed') {
                assert_array_equals(violationEvents, [], 'no violation events should be fired');
              } else {
                assert_equals(violationEvents.length, 1, 'One violation event should be fired');
              }
            case 4:
            case "end":
